...
public static void main(String args[]){
    ...
    char my_character ;
    String[] values = {"File","Text Input"};

    Object selected = JOptionPane.showInputDialog(null, "What do you want to encrypt?", "Selection", JOptionPane.DEFAULT_OPTION, null, values, "0");
        if ( selected != null ){ 
